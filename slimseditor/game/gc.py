...
from slimseditor.saveentry import Boolean, Integer, RangedInteger
...
def get_gc_items():
    return {
        ...
        "Weapon Ammo": [
            RangedInteger("Clank Zapper", 0x1c8, 30),
            RangedInteger("Bomb Glove", 0x1c8, 40),
            RangedInteger("Visibomb Gun", 0x1d8, 20),
            RangedInteger("Decoy Glove", 0x1e8, 20),
            RangedInteger("Tesla Claw", 0x1f0, 300),
            RangedInteger("Chopper", 0x200, 35),
            RangedInteger("Pulse Rifle", 0x204, 8),
            RangedInteger("Seeker Gun", 0x208, 25),
            RangedInteger("Hoverbomb Gun", 0x20c, 10),
            RangedInteger("Blitz Gun", 0x210, 40),
            RangedInteger("Minirocket Tube", 0x214, 25),
            RangedInteger("Plasma Coil", 0x218, 15),
            RangedInteger("Lava Gun", 0x21c, 200),
            RangedInteger("Lancer", 0x220, 200),
            RangedInteger("Synthenoid", 0x224, 12),
            RangedInteger("Spiderbot Glove", 0x228, 8),
            RangedInteger("Bouncer", 0x23c, 25),
            RangedInteger("Miniturret Glove", 0x24c, 20),
            RangedInteger("Zodiac", 0x254, 4),
            RangedInteger("RYNO II", 0x258, 100),
            RangedInteger("Shield Charger", 0x25c, 5),
        ],
        "Weapon Unlocks": [
